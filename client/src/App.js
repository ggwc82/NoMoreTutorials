    ...
    return (
      <div>
        ...
        <ul>
          ...
          <li>x_coord: {this.state.location.x_coord}</li>
          <li>y_coord: {this.state.location.y_coord}</li>
          <li>z_coord: {this.state.location.z_coord}</li>
        </ul>
        </div>
        <TrackingCanvas location={this.state.location}/>
      </div>
      );
  }
}
